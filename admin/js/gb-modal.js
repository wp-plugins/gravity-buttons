jQuery(document).ready(function($){
	...
	GBModal = function(save_function) {
		var self = this;
		...
		self.bindColorPickers = function(){
			...
			var colpickOptions = {
				...
				onBeforeShow: function(){
					...
					$(".gb-color-picker-input").colpickHide();
			...
			$("#gb-primary-color-input").colpick(colpickOptions).keyup(function(){
		...
		ko.applyBindings(self, $('#gb-modal')[0]);
